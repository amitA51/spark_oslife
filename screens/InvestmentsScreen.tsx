        ...
        >
            <div className="flex justify-between items-start mb-4">
                <div className="flex flex-col">
                    <div className="flex items-baseline gap-2">
                         <h3 className="text-xl font-bold text-white tracking-tight font-mono">{asset.ticker}</h3>
                         <span className="text-[10px] text-[var(--text-secondary)] font-bold truncate max-w-[100px] uppercase tracking-wider bg-white/5 px-1.5 py-0.5 rounded">{asset.name}</span>
                    </div>
                     <div className="flex items-baseline gap-2 mt-1">
                        <span className="text-2xl font-medium text-white font-mono tracking-tight">${price}</span>
                    </div>
                </div>
            ...
            <div className="h-12 flex items-end justify-between">
                 <button
                    ...
                    className="text-[var(--text-secondary)] hover:text-red-400 transition-colors p-1.5 hover:bg-red-500/10 rounded-lg opacity-0 group-hover:opacity-100"
...
const SkeletonCard: React.FC = () => (
  <div className="themed-card p-5 shimmer-bg">
    <div className="flex justify-between items-start mb-4">
        <div>
            <div className="h-6 w-16 bg-[var(--bg-secondary)] rounded-md mb-2"></div>
            <div className="h-8 w-32 bg-[var(--bg-secondary)] rounded-md"></div>
        </div>
        <div className="h-8 w-16 bg-[var(--bg-secondary)] rounded-md"></div>
    </div>
    <div className="mt-2 h-12 w-full bg-[var(--bg-secondary)]/50 rounded-lg"></div>
  </div>
);
        ...
        <div className="pt-4 pb-8 space-y-6">
            <form onSubmit={handleAdd} className="flex gap-2 relative z-20">
                <input
                    ...
                    className="glass-input w-full text-[var(--text-primary)] rounded-xl p-4 focus:outline-none font-mono uppercase placeholder:normal-case placeholder:font-sans"
                />
                <button type="submit" disabled={isAdding} className="bg-[var(--accent-gradient)] text-white font-bold p-4 rounded-xl disabled:opacity-50 transition-transform transform active:scale-97 hover:brightness-110 shadow-lg shadow-[var(--dynamic-accent-start)]/30 hover:shadow-[0_0_15px_var(--dynamic-accent-glow)]">
