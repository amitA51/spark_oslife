        ...
        <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-2xl p-4">
                    <div className="flex justify-around text-center">
                        <div>
                            ...
                            <div className="text-2xl font-bold text-green-400">{formatDuration(item.workoutDuration)}</div>
                        </div>
            ...
            {hasExercises ? (
                ...
                <div className="text-center py-12 px-4">
                    ...
                    <p className="text-[var(--text-secondary)] mb-6">התחל מתבנית או ערוך את האימון להוספת תרגילים</p>
                </div>
            )}
