        ...
        <div className="space-y-4">
            ...
            <div className="p-4 bg-[var(--bg-secondary)] rounded-xl border border-[var(--border-primary)]">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1">תאריך</label>
                        <input 
                            type="date" 
                    ...
                    <div>
                        <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1">שעה</label>
                        <input 
                            type="time" 
