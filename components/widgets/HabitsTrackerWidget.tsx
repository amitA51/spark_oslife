...
const HabitsTrackerWidget: React.FC<HabitsTrackerWidgetProps> = ({ onHabitClick, onHabitToggle }) => {
                            ...
                            >
                                <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        <p className={`font-medium truncate ${completed ? 'text-[var(--text-secondary)] line-through' : 'text-[var(--text-primary)]'}`}>
                                            {habit.title}
                                        </p>
                                        {habit.frequency && (
