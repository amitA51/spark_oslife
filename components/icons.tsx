...
export const getFileIcon = (mimeType: string) => {
    ...
    if (mimeType.includes('document') || mimeType.includes('msword')) return <DocIcon className={`${cls} text-blue-400`} />;
    return <FileIcon className={`${cls} text-gray-400`} />;
};

// --- Premium Icon Set (Consistent Stroke 1.5px & Geometry) ---

export const SparklesIcon: React.FC<IconProps> = ({ className, filled, style }) => (
...
export const TargetIcon: React.FC<IconProps> = ({ className, filled, style }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
        <circle cx="12" cy="12" r="10" stroke={filled ? "none" : "currentColor"} fill={filled ? "currentColor" : "none"} opacity={filled ? 0.2 : 1} />
        <circle cx="12" cy="12" r="6" />
        <circle cx="12" cy="12" r="2" fill="currentColor" />
    </svg>
);

export const FeedIcon: React.FC<IconProps> = ({ className, filled, style }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
        ...
        <path d="M5 20C5.55228 20 6 19.5523 6 19C6 18.4477 5.55228 18 5 18C4.44772 18 4 18.4477 4 19C4 19.5523 4.44772 20 5 20Z" fill="currentColor" stroke="none" />
    </svg>
);

export const LayoutDashboardIcon: React.FC<IconProps> = ({ className, filled, style }) => (
    <svg viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const ChartBarIcon: React.FC<IconProps> = ({ className, filled, style }) => (
    <svg viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
        <path d="M18 20V10" />
        <path d="M12 20V4" />
        <path d="M6 20V14" />
...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className, style }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const ShieldExclamationIcon: React.FC<IconProps & { title?: string }> = ({ className, title, style }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
...
export const GoogleIcon: React.FC<IconProps> = ({ className, style }) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
        <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="none" fill="#fff" fillOpacity="0.1" />
        <path d="M20.2826 12.2424C20.2826 11.4909 20.1626 10.8394 19.9826 10.2394H12V13.3879H16.7426C16.6109 14.2576 15.987 15.5242 14.8109 16.3364L14.7948 16.4436L17.3594 18.4273L17.537 18.4455C19.1674 16.9455 20.2826 14.7394 20.2826 12.2424Z" fill="#4285F4" />
        <path d="M12 20.4848C14.3296 20.4848 16.2848 19.7121 17.7109 18.4455L14.8109 16.3364C14.0783 16.8424 13.1304 17.1606 12 17.1606C9.72174 17.1606 7.77652 15.6606 7.08 13.6394L6.97391 13.6485L4.30826 15.7121L4.27174 15.8121C5.68696 18.6212 8.61913 20.4848 12 20.4848Z" fill="#34A853" />
        <path d="M7.08 13.6394C6.89348 13.1061 6.78652 12.5364 6.78652 11.9515C6.78652 11.3667 6.89348 10.797 7.08 10.2636L7.07478 10.1515L4.37826 8.06364L4.27174 8.09091C3.68478 9.25758 3.35217 10.5727 3.35217 11.9515C3.35217 13.3303 3.68478 14.6455 4.27174 15.8121L7.08 13.6394Z" fill="#FBBC05" />
        <path d="M12 6.73939C13.6278 6.73939 14.7174 7.43939 15.3413 8.03333L17.7826 5.64545C16.2783 4.23939 14.3296 3.41818 12 3.41818C8.61913 3.41818 5.68696 5.28182 4.27174 8.09091L7.08 10.2636C7.77652 8.24242 9.72174 6.73939 12 6.73939Z" fill="#EA4335" />
    </svg>
);
