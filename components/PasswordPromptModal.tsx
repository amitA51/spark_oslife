...
const PasswordPromptModal: React.FC<PasswordPromptModalProps> = ({ isOpen, onClose, onSubmit, title = "Enter Password", description, isConfirm = false }) => {
                ...
                <div className="p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex justify-end gap-3 mt-6">
                            <button type="button" onClick={onClose} className="px-4 py-2 rounded-xl text-[var(--text-secondary)] hover:bg-[var(--bg-tertiary)] transition-colors">
                                ביטול
                            </button>
                            <button type="submit" className="px-4 py-2 rounded-xl bg-[var(--accent-gradient)] text-white font-bold shadow-lg hover:brightness-110 transition-all">
                                אישור
                            </button>
                        </div>
                    </form>
