...
export const useThemeEffect = ({ themeSettings, uiDensity, animationIntensity, fontSizeScale }: UseThemeEffectProps) => {
    useEffect(() => {
        ...
        // Apply font class
        body.classList.remove('font-inter', 'font-lato', 'font-source-code-pro', 'font-heebo', 'font-rubik', 'font-alef', 'font-poppins');
        ...
        root.style.setProperty('--radius-card', radiusMap[currentRadius]);
        ...
        root.style.setProperty('--font-weight-base', weightMap[themeSettings.fontWeight || 'normal']);
